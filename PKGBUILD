...
source=("git+https://github.com/labwc/${_pkgname}.git"
        ...
        '0001-cursor-also-toggle-mousebind-with-ToggleKeybinds.patch')
md5sums=('SKIP'
         'a62974a65da84d1d36a198e7b7c1538a'
         'b8cf39a376fdb4ec7fa0117529a41b1a')
...
prepare() {
  ...
  patch -Np1 -i ../0001-cursor-also-toggle-mousebind-with-ToggleKeybinds.patch
}
